...
class LineBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // `label` para el lector de pantalla: sin esto TalkBack lee "3" suelto,
    // que al lado del nombre del recorrido no se entiende qué es. El color de
    // la chapa no se puede "leer", así que la palabra "línea" lo reemplaza.
    return Semantics(
      label: 'Línea $code',
